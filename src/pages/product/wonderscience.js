...
const CaseStudy2 = ()=> {
        ...
        return (
            <Layout data={data.WonderScience[0].Navigation}  >
                ...
                <CSHero noRadius data={data.WonderScience[1].Hero}/>             
                ...
                <div style={{display:`flex`,maxWidth:`888px`,margin:`auto`}}><AniLink style={{color:`black`,marginLeft:`auto`,padding:`0 52px 26px 0`,fontWeight:`bold`}} fade to="/product/prnetwork" >Next -> </AniLink></div>
            </Layout>
        );
